...
DefaultGroupName=AVKtimer Studio v1.8
AllowNoIcons=yes
Compression=lzma
...
OutputBaseFilename=AVKtimer_Studio_v1.8_Setup
...
[Icons]
Name: "{group}\AVKtimer Studio v1.8"; Filename: "{app}\AVKtimer.exe"; IconFilename: "{app}\app.ico"
Name: "{autodesktop}\AVKtimer Studio v1.8"; Filename: "{app}\AVKtimer.exe"; Tasks: desktopicon; IconFilename: "{app}\app.ico"
